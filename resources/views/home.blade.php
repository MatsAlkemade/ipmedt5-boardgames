        ...
        <article class="home__main">
            ...
            <ul class="home__games">
                <li class="home__game">
                    ...
                    <button class="home__game__button u-button-style" onclick="location.href = '/vieropeenrij';">Spelen</button>
                </li>
                <li class="home__game">
                    <figure class="home__game__figure">
                    ...
                    <button class="home__game__button u-button-style" onclick="location.href = '/thirtyseconds';">Spelen</button>
                </li>
                <li class="home__game">
                    <figure class="home__game__figure">
                    ...
                    <button class="home__game__button u-button-style" onclick="location.href = '/trivialpursuit';">Spelen</button>
                </li>
                <li class="home__game">
                    <figure class="home__game__figure">
                    ...
                    <button class="home__game__button u-button-style" onclick="location.href = '/vlottegeest';">Spelen</button>
                </li>
                <li class="home__game">
                    <figure class="home__game__figure">
                    ...
                    <button class="home__game__button u-button-style" onclick="location.href = '/ganzenbord';">Spelen</button>
                </li>
            </ul>
        </article>
