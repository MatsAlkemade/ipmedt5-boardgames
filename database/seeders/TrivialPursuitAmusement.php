...
class TrivialPursuitAmusement extends Seeder
{
    ...
    public function run()
    {
        $question_array = ["Wat is de meest bekeken video op Youtube?", "Wat is de meest populaire sport ter wereld?", "Wat is het grootste Youtube kanaal?", "Wat is de meest verkochten video game?", "Wat is het meest winstgevende franchise?", "Welk social media platform heeft de meeste gebruikers?", "Hoe heet de moeder van Homer Simpson in de tv-serie the Simpsons?", "Sinds welk jaar is Goede Tijden Slechte Tijden op tv te zien?", "Waarvoor staat de afkorting MTV, het bekende televisienetwerk?", "Hoe hhet de maker van Spongebob?", "Hoe zou de serie the Flintstones oorspronkelijk gaan heten?", "Wie is de duurste voetbal transfer aller tijden?", "Waar staat de afkorting MC in de hiphopscene voor?", "Waar staat de googelaar Houdini bekend om?", "Wat is de meest verkochten musical?"];
